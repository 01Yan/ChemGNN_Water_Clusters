...
def get_adj_matrix(dmatrix, atom_types):
    ...
    cutoffs = {('H', 'H'): 0.8 * 2.0, ('H', 'O'): 1.2 * 2.0, ('O', 'H'): 1.2 * 2.0, ('O', 'O'): 1.4 * 2.0}
...
def generate_d_bt():
    # base_dir = '/Users/yanhongyu/Documents/课程资料/summer_project/soap_1-21-water_energy/1/data/'
    # pattern = '*WATER'  # 使用通配符匹配多个文件夹
    #
    # # 使用glob找到所有匹配的文件夹
    ...
    #     output_dir = os.path.join(directory, 'BTMATRIXES2')
    #     # input_dir = os.path.join(directory, 'CONFIG')
    #     # output_dir = os.path.join(directory, 'DMATRIXES')
    #
    #     os.makedirs(output_dir, exist_ok=True)

    d_path = '/Users/yanhongyu/Documents/课程资料/summer_project/soap_1-21-water_energy/1/data/DATA 1/DMATRIXES'
    c_path = '/Users/yanhongyu/Documents/课程资料/summer_project/soap_1-21-water_energy/1/data/DATA 1/CONFIG'
    output_dir = '/Users/yanhongyu/Documents/课程资料/summer_project/soap_1-21-water_energy/1/data/DATA 1/BTMATRIXES2'

    os.makedirs(output_dir, exist_ok=True)

    for i in range(0, 3003):
